...
public class Content {
	...
	public static BufferedImage[][] ENEMY = load("/Sprites/enemy.gif",16,16);
	public static BufferedImage[][] GOLD = load("/Sprites/gold.gif", 16, 16);
	...
	public static void drawRect(Graphics2D r,int x,int y,int width,int height, int red, int green, int blue){
